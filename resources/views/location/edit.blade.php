                            ...
                            <div class="row" style="padding:5px;">
                                <div class="col-md-6" style="padding-right:100px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->display_name }}" required autocomplete="name" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->location_code }}" required autocomplete="location_code" autofocus maxlength="5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('location_type') is-invalid @enderror location_type" id="location_type" name="location_type" required >
                                            ...
                                            <option value="Logistics Warehouse" {{$location->location_type == "Logistics Warehouse"?"selected":""}} >Logistics Warehouse</option>
                                            <option value="Logistics Hub" {{$location->location_type == "Logistics Hub"?"selected":""}}>Logistics Hub</option>
                                            <option value="Company Warehouse" {{$location->location_type == "Company Warehouse"?"selected":""}}>Company Warehouse</option>
                                            <option value="3rd Party Warehouse" {{$location->location_type == "3rd Party Warehouse"?"selected":""}}>3rd Party Warehouse</option>
                                        </select>
                                        @error('location_type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row" style="padding:5px;">
                                <div class="col-md-6" style="padding-right:100px;">
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->address_line_1 }}"  autocomplete="address_line_1" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->city }}"  autocomplete="city" autofocus>
                                        @error('city')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->post_code }}"  autocomplete="post_code" autofocus>
                                        @error('post_code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->address_line_2 }}"  autocomplete="address_line_2" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->region }}"  autocomplete="region" autofocus>
                                        @error('region')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('country') is-invalid @enderror country" id="country" name="country"  >
                                            ...
                                            <option value="{{ $country->country_name }}"{{ $country->country_name == $location->country?"selected":""}}>{{ $country->country_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('region')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="card">
                            ...
                            <div class="row" style="padding:5px;">
                                <div class="col-md-6" style="padding-right:100px;">
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->general_inquiry_phone }}"   autocomplete="general_inquiry_phone" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->primary_contact_name }}"   autocomplete="primary_contact_name" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->primary_contact_email }}"  autocomplete="primary_contact_email" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->primary_contact_phone }}"  autocomplete="primary_contact_phone" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->general_inquiry_email }}"   autocomplete="general_inquiry_email" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->secondary_contact_name }}"  autocomplete="secondary_contact_name" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->secondary_contact_email }}"  autocomplete="secondary_contact_email" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ $location->secondary_contact_phone }}"  autocomplete="secondary_contact_phone" autofocus>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"  id="status" name="status" {{ $location->status==1?"checked":""}}/>
                            ...
                            <div class="row" style="padding:5px;">
                                <div class="col-md-6" style="padding-right:100px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br/>
                                        <?php $group_org_id =$location->organization()->pluck("organization_id")->toArray(); ?>
                                        <select class="form-control @error('Organization') is-invalid @enderror organization" id="organization[]" name="organization[]" required multiple="multiple" >
                                            ...
                                            <option value="{{ $organization->id }}" {{ in_array($organization->id , $group_org_id)?"selected":"" }} >{{ $organization->organization_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('organization')
                                        <span class="invalid-feedback" role="alert">
